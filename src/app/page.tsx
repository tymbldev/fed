...
import { fetchIndustries, fetchTopDesignations, fetchTopSkills } from './utils/serverData';
...
export default async function Home() {
  // Get all data concurrently using Promise.all for better performance
  const [industries, { topDesignations }, { topSkills }] = await Promise.all([
    fetchIndustries(),
  ...
  return (
    <main className="min-h-screen bg-white dark:bg-gray-900">
      ...
      <TopSkillsShowcase skills={topSkills} />
