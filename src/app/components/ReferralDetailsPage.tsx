      ...
      <div className="container mx-auto px-4 max-w-4xl">
        <div className="bg-white md:rounded-2xl md:shadow-lg md:border md:border-gray-200 p-4 pb-0 md:p-8 text-left">
          ...
          <div className="mb-6">
            ...
            <Link href={buildCompanySeoPath({ name: referral.company, id: referral.companyId })} className="text-base text-gray-500 font-medium mb-2 text-left hover:underline">{referral.company}</Link>
