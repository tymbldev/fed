      ...
      <div className="flex gap-2">
        <div className="w-1/3">
          <input
            ...
            className={`block w-full h-10 px-3 rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500 text-sm ${touched['phone'] && errors['phone'] ? 'border-red-500' : ''}`}
            inputMode="numeric"
            pattern="[0-9]*"
            minLength={2}
            maxLength={3}
